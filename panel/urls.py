...
urlpatterns = [
    ...
    path('degerlendirme-qr/', views.degerlendirme_qr_yonetim, name='degerlendirme_qr_yonetim'),
    path('degerlendirmeler/', views.degerlendirmeler, name='degerlendirmeler'),
    path('degerlendirme/<str:token>/', views.musteri_degerlendirme, name='musteri_degerlendirme'),
    ...
    path('egitim/yonetim/excel/', views.egitim_excel_export, name='egitim_excel_export'),
    path('egitim/yonetim/kisi/<int:pid>/', views.egitim_kisi_detay, name='egitim_kisi_detay'),
    path('egitim/yonetim/kisi/<int:pid>/excel/', views.egitim_kisi_excel_export, name='egitim_kisi_excel_export'),
